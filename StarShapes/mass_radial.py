...
ax[0].set_title("Distribution of mass across nodes")
...
plt.tight_layout()
plt.savefig("./StarShapes/Images/mass_radial_heatmaps.png", dpi=700)
plt.show()

fig, ax = plt.subplots(1, 2, figsize=(10, 5))

# Plot 1: Different P values for mass
